...
/**
 * @notice Deploys a singleton `RecoveryDispatcher` on one destination chain. Run once per
 *         chain in {Ethereum, Arbitrum, Base, Linea, Polygon, Avalanche, BSC}. Impl is
 ...
 */
contract DeployRecoveryDispatcher is Utils, RecoveryDeployHelper {
    function run() external {
        ...
        console.log("RecoveryDispatcher impl : %s", impl);
        console.log("RecoveryDispatcher proxy: %s", address(dispatcher));
