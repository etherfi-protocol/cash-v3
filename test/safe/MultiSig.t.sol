...
contract MultiSigTest is SafeTestSetup {
    ...
    function testFuzz_configureOwners_correctlyUpdatesOwnerStatus(
        address[10] calldata ownerAddresses,
        bool[10] calldata shouldAddFlags
    ) public {
    ...
    function _configureOwners(
        address[] memory owners,
        bool[] memory shouldAdd,
        uint256 pk1,
        uint256 pk2
    ) internal {
        bytes32 structHash = keccak256(abi.encode(
