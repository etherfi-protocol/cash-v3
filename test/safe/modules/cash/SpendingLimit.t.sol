...
contract CashModuleSpendingLimitTest is CashModuleTestSetup {
    ...
    function test_updateSpendingLimit_works() public {
        ...
        cashModule.spend(address(safe), keccak256("txId"), address(usdcScroll), transferAmount);
    ...
    function test_SpendingLimitGetsRenewedAutomatically() public {
        ...
        cashModule.spend(address(safe), keccak256("newTxId"), address(usdcScroll), dailyLimit - amount + 1);
