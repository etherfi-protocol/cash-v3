...
/// @title Arbitrum TopUp Bytecode Verification
/// @notice Verifies that every deployed TopUp contract on Arbitrum matches the bytecode from this repo.
///
/// Usage:
///   forge test --match-contract VerifyTopUpArbitrumBytecode -vv
contract VerifyTopUpArbitrumBytecode is ContractCodeChecker, Utils {
    bytes32 constant EIP1967_IMPL_SLOT = 0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc;

    string deployments;

    function setUp() public {
        string memory rpc = _tryEnv("ARBITRUM_RPC", "https://arb1.arbitrum.io/rpc");
