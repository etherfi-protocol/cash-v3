...
/**
 * @title EtherFiSafeCore
 * @notice Shared concrete safe surface used by both the OP-side `EtherFiSafe` and the
 *         other chains `TradingSafe`. Holds initialization, admin / module surface, and
 *         the safe's public read/write methods.
 * @author ether.fi
 */
abstract contract EtherFiSafeCore is EtherFiSafeBase, ModuleManager, RecoveryManager, MultiSig {
